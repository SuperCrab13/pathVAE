...
def main(batch_size=32, lr=4e-4, cancer='lihc', lam_l2=1e-5, epoch=10, lam_reg=1e-4, alpha_surv=0, result_dir='result_test', model_type="PathVAE"):
    seed_torch(1)
    ...
    pathway = pd.read_csv('./data_test/hallmarks_signatures.csv')
...
if __name__ == '__main__':
    ...
    main(model_type='PathVAE', cancer='luad', batch_size=64, lr=1e-3, epoch=10)
