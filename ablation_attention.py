...
import torch
import numpy as np
from PathVAE import PathVAE_ablation
...
def main(batch_size=32, lr=4e-4, cancer='lihc', lam_l2=1e-5, epoch=10, lam_reg=1e-4, alpha_surv=0, result_dir='result_ablation_attn', model_type="PathVAE"):
    seed_torch(1)
    ...
    for split in range(5):
        ...
        model = PathVAE_ablation(input_feature=train_set.omic_dict, p_mask=0.5)
